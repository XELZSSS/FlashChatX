                ...
                {tabs.map(tab => {
                    ...
                    return (
                        <button
                            ...
                            className={`settings-tab flex items-center gap-2 md:gap-3 px-5 md:px-6 py-3 md:py-3.5 rounded-xl text-[15px] font-medium transition-all whitespace-nowrap ${isActive
