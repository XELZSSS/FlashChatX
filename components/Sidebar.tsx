...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  if (!isOpen) {
    return (
      <div className="absolute left-4 top-6 z-[60]">
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div className="sidebar-panel flex flex-col h-full w-64 flex-shrink-0 transition-all duration-300 fixed md:relative z-[60] md:z-[60] h-screen md:h-full">
        {/* Header */}
